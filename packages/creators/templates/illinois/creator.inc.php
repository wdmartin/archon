...
{
   ?>
<div class='CreatorEntry'><span class='bold'><a href='#' onclick="toggleDisplay('relatedcreators'); return false;"><img id='relatedcreatorsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> Show Related People or Groups</a> <!--<span style='font-size:80%'>(links to similar collections)</span> --></span><br />
...
{
   ?>
<div class='CreatorEntry'><span class='bold'><a href='#' onclick="toggleDisplay('LinkedCollections'); return false;"><img id='LinkedCollectionsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> Show Related Collections</a></span><br/>
...
{
   ?>
<div class='CreatorEntry'><span class='bold'><a href='#' onclick="toggleDisplay('LinkedAccessions'); return false;"><img id='LinkedAccessionsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> Show Related Unprocessed Materials</a></span><br/>
...
{
   ?>
<div class='CreatorEntry'><span class='bold'><a href='#' onclick="toggleDisplay('LinkedBooks'); return false;"><img id='LinkedBooksImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> Show Related Books</a></span><br/>
